const config = {
    stripe_test_secret_key: process.env.STRIPE_PW || "pk_test_Rcvq9IbB69oZewksljuOumTI",
    stripe_test_api_key: process.env.STRIPE_API_KEY || "pk_test_Rcvq9IbB69oZewksljuOumTI",
